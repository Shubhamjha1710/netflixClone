...
import {API_KEY , TMDB_BASE_URL} from '../utils/api_key'
...
const createArrayFromRawData = (array ,moviesArray , genres)=> {
    array.forEach((movie)=>{
        const movieGenres = [];
        const videoYoutubeKey = 'tlzO2kvAjlw';
...
export const fetchMoviesByGenre = createAsyncThunk('netflix/genre' , async({type , genre} , thunkApi)=>{
